...
constexpr inline Color make_rgba(types::u8 red, types::u8 green, types::u8 blue,
                                 types::u8 alpha = 255) noexcept {
  return Color(red, green, blue, alpha);
}

/// @brief Create a Color from BGR-ordered channel values (legacy Build assets)
constexpr inline Color make_from_bgr(types::u8 blue, types::u8 green,
                                     types::u8 red,
                                     types::u8 alpha = 255) noexcept {
  return Color(red, green, blue, alpha);
}
...
constexpr inline types::u32 pack_rgba(types::u8 red, types::u8 green,
                                      types::u8 blue,
                                      types::u8 alpha = 255) noexcept {
...
/// tolerance
constexpr inline bool is_build_engine_magenta(types::u8 r, types::u8 g,
                                              types::u8 b) noexcept {
