...
struct Color {
    ...
    constexpr Color(types::u8 red, types::u8 green, types::u8 blue, types::u8 alpha = 255)
    ...
    constexpr Color premultiplied() const noexcept {
        const types::u16 alpha_factor = static_cast<types::u16>(a) + 1; // +1 for rounding
        return Color(
            static_cast<types::u8>((static_cast<types::u16>(r) * alpha_factor) >> 8),
            static_cast<types::u8>((static_cast<types::u16>(g) * alpha_factor) >> 8),
            static_cast<types::u8>((static_cast<types::u16>(b) * alpha_factor) >> 8),
            a
        );
    }
