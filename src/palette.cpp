...
constexpr uint8_t scale_component(uint8_t value) {
    // Scale 0-63 component to classic Build Engine 8-bit range
    return static_cast<uint8_t>(std::min<uint16_t>(255, static_cast<uint16_t>(value) << 2));
}

constexpr uint8_t to_6bit(uint8_t value) {
    return static_cast<uint8_t>(std::min<uint16_t>(63, (static_cast<uint16_t>(value) + 2) >> 2));
}
...
bool Palette::load_from_file(const std::filesystem::path& filename) {
    ...
    const bool is_scaled_input = std::any_of(buffer.begin(), buffer.end(), [](uint8_t value) { return value > 63; });
...
bool Palette::load_from_memory(const uint8_t* data, size_t size) {
    ...
    const bool is_scaled_input = std::any_of(data, data + SIZE, [](uint8_t value) { return value > 63; });
...
void Palette::load_duke3d_default() {
    static const uint8_t duke3d_palette[SIZE] = {
          0,   0,   0,   1,   1,   1,   4,   3,   4,   6,   6,   6,
          9,   8,   8,  11,  10,  11,  14,  13,  13,  16,  15,  15,
         19,  18,  18,  22,  20,  20,  24,  22,  23,  27,  24,  25,
         29,  27,  28,  32,  29,  30,  34,  31,  32,  37,  34,  35,
         38,  35,  36,  40,  37,  38,  42,  39,  40,  43,  41,  42,
         44,  43,  43,  46,  44,  45,  48,  46,  46,  50,  47,  48,
         51,  49,  50,  53,  51,  52,  54,  53,  54,  56,  54,  55,
         57,  56,  57,  59,  58,  59,  61,  60,  61,  63,  63,  63,
          0,   0,   0,   1,   1,   0,   3,   1,   1,   6,   3,   1,
          8,   4,   2,  10,   5,   3,  12,   7,   4,  15,   8,   5,
         17,   9,   6,  19,  11,   6,  21,  12,   7,  24,  13,   8,
         26,  15,   9,  28,  16,  10,  30,  17,  11,  33,  19,  12,
         35,  21,  14,  36,  23,  15,  38,  25,  17,  40,  27,  18,
         42,  29,  20,  43,  31,  22,  44,  33,  24,  46,  36,  26,
         47,  38,  28,  49,  40,  30,  51,  43,  32,  53,  44,  35,
         54,  46,  37,  55,  49,  39,  57,  51,  42,  59,  54,  44,
         20,  24,  37,  21,  26,  38,  23,  28,  40,  24,  30,  42,
         26,  32,  43,  28,  34,  45,  30,  36,  47,  31,  38,  49,
         33,  41,  51,  35,  43,  52,  37,  44,  54,  39,  46,  55,
         41,  49,  57,  43,  51,  59,  45,  53,  61,  47,  55,  63,
          0,   0,   0,   1,   1,   1,   1,   2,   4,   3,   3,   6,
          4,   5,   8,   5,   6,  11,   6,   8,  13,   8,  10,  16,
          9,  11,  18,  10,  13,  20,  11,  14,  23,  13,  16,  25,
         14,  17,  27,  15,  19,  30,  16,  20,  32,  18,  22,  35,
          0,   0,   0,   1,   1,   1,   3,   3,   2,   6,   5,   3,
          8,   8,   4,  10,  10,   6,  12,  12,   7,  15,  14,   9,
         17,  16,  10,  19,  19,  11,  21,  21,  13,  24,  23,  14,
         26,  25,  16,  28,  27,  17,  30,  29,  18,  33,  32,  20,
         35,  34,  21,  37,  37,  21,  38,  39,  22,  39,  41,  23,
         40,  43,  24,  41,  44,  24,  42,  46,  25,  43,  48,  26,
         43,  50,  26,  43,  52,  27,  44,  54,  27,  44,  55,  28,
         44,  57,  28,  44,  59,  29,  44,  61,  29,  44,  63,  30,
          0,   0,   0,   3,   0,   0,   6,   1,   0,  10,   1,   0,
         13,   2,   1,  17,   3,   1,  21,   4,   1,  24,   5,   1,
         28,   6,   2,  32,   7,   2,  35,   8,   3,  39,   9,   3,
         43,  10,   3,  46,  11,   4,  50,  12,   4,  54,  13,   5,
         25,  17,   6,  26,  20,   1,  29,  22,   1,  32,  25,   1,
         35,  27,   2,  37,  30,   2,  40,  32,   2,  43,  35,   2,
         44,  37,   4,  47,  40,   4,  50,  43,   4,  53,  45,   5,
         54,  48,   5,  57,  50,   5,  60,  54,   5,  63,  56,   6,
          0,   0,   0,   1,   1,   0,   2,   2,   1,   4,   3,   2,
          5,   4,   4,   7,   5,   5,   8,   7,   6,  10,   8,   7,
         12,   9,   8,  13,  11,  10,  15,  12,  11,  16,  13,  12,
         18,  15,  13,  19,  16,  14,  21,  17,  16,  23,  19,  17,
         25,  21,  19,  27,  23,  20,  30,  25,  22,  32,  27,  24,
         35,  29,  26,  37,  31,  28,  39,  33,  30,  42,  35,  31,
         43,  37,  33,  45,  39,  35,  48,  41,  37,  50,  43,  39,
         53,  44,  41,  54,  46,  43,  56,  49,  44,  59,  51,  46,
         13,   7,   0,  17,  10,   0,  22,  12,   0,  27,  14,   0,
         32,  16,   0,  36,  18,   0,  41,  20,   0,  45,  21,   1,
         50,  23,   1,  51,  26,   6,  53,  29,  12,  54,  33,  17,
         55,  36,  22,  57,  40,  28,  59,  43,  34,  61,  48,  40,
         54,  16,   6,  54,  19,   7,  55,  23,  10,  56,  26,  12,
         57,  30,  14,  58,  33,  16,  59,  36,  18,  60,  40,  20,
         60,  43,  23,  60,  46,  25,  61,  49,  29,  61,  52,  31,
         62,  54,  35,  62,  56,  37,  62,  58,  41,  63,  60,  43,
          2,   4,  13,   2,   2,  16,   5,   2,  19,   7,   2,  22,
         12,   2,  23,  16,   4,  25,  21,   5,  26,  26,   6,  28,
         31,   6,  30,  34,   8,  29,  38,   8,  27,  41,   6,  24,
         44,  10,  19,  47,  11,  14,  51,  12,   6,  54,  13,   5,
         17,  17,   0,  41,  41,   0,  63,  63,   0,  17,   0,  17,
         41,   0,  41,  63,   0,  63,  22,   0,   0,  43,   0,   0,
         63,   0,   0,   0,  17,   0,   0,  41,   0,   0,  63,   0,
          0,   0,  17,   0,   0,  41,   0,   0,  63,  63,   0,  63,
    };
...
void Palette::convert_to_tga_format() {
    // Backwards compatibility: keep public API intact
    update_bgr_cache();
}
...
void Palette::update_bgr_cache() {
    if (raw_data_.size() != SIZE) {
        bgr_data_.clear();
        return;
    }

    if (bgr_data_.size() != SIZE) {
        bgr_data_.resize(SIZE);
    }
    ...
    for (size_t i = 0; i < SIZE; i += 3) {
        ...
        bgr_data_[i]     = scale_component(b); // Blue channel first
        bgr_data_[i + 1] = scale_component(g);
        bgr_data_[i + 2] = scale_component(r);
    }
}
