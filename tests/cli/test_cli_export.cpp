...
TEST_SUITE("CLI Export Tests") {
    ...
    TEST_CASE_FIXTURE(CliTestFixture, "CLI basic export command structure") {
        ...
        std::vector<std::string> args = {"art2img", art_file.string(), "-p", palette_file.string(), "-o", output_dir.string()};
    ...
    TEST_CASE_FIXTURE(CliTestFixture, "CLI export with PNG format") {
        std::vector<std::string> args = {"art2img", art_file.string(), "-p", palette_file.string(), "-o", output_dir.string(), "-f", "png"};
        auto argv = make_argv(args);
    ...
    TEST_CASE_FIXTURE(CliTestFixture, "CLI export with TGA format") {
        std::vector<std::string> args = {"art2img", art_file.string(), "-p", palette_file.string(), "-o", output_dir.string(), "-f", "tga"};
        auto argv = make_argv(args);
    ...
    TEST_CASE_FIXTURE(CliTestFixture, "CLI export with BMP format") {
        std::vector<std::string> args = {"art2img", art_file.string(), "-p", palette_file.string(), "-o", output_dir.string(), "-f", "bmp"};
        auto argv = make_argv(args);
    ...
    TEST_CASE_FIXTURE(CliTestFixture, "CLI export with invalid format") {
        std::vector<std::string> args = {"art2img", art_file.string(), "-p", palette_file.string(), "-o", output_dir.string(), "-f", "invalid"};
        auto argv = make_argv(args);
    ...
    TEST_CASE_FIXTURE(CliTestFixture, "CLI export missing palette file") {
        std::vector<std::string> args = {"art2img", art_file.string(), "-o", output_dir.string()};
        auto argv = make_argv(args);
    ...
    TEST_CASE_FIXTURE(CliTestFixture, "CLI export missing input file") {
        std::vector<std::string> args = {"art2img", "-p", palette_file.string(), "-o", output_dir.string()};
        auto argv = make_argv(args);
    ...
    TEST_CASE_FIXTURE(CliTestFixture, "CLI export with verbose output") {
        std::vector<std::string> args = {"art2img", art_file.string(), "-p", palette_file.string(), "-o", output_dir.string(), "-v"};
        auto argv = make_argv(args);
    ...
    TEST_CASE_FIXTURE(CliTestFixture, "CLI export with quiet output") {
        std::vector<std::string> args = {"art2img", art_file.string(), "-p", palette_file.string(), "-o", output_dir.string(), "-q"};
        auto argv = make_argv(args);
    ...
    TEST_CASE_FIXTURE(CliTestFixture, "CLI export with custom filename prefix") {
        std::vector<std::string> args = {"art2img", art_file.string(), "-p", palette_file.string(), "-o", output_dir.string(), "--prefix", "custom_"};
        auto argv = make_argv(args);
    ...
    TEST_CASE_FIXTURE(CliTestFixture, "CLI export directory processing") {
        ...
        std::vector<std::string> args = {"art2img", art_dir.string(), "-p", palette_file.string(), "-o", output_dir.string()};
        auto argv = make_argv(args);
    ...
    TEST_CASE_FIXTURE(CliTestFixture, "CLI export with parallel processing") {
        std::vector<std::string> args = {"art2img", art_file.string(), "-p", palette_file.string(), "-o", output_dir.string(), "-j", "2"};
        auto argv = make_argv(args);
    ...
    TEST_CASE_FIXTURE(CliTestFixture, "CLI export with transparency options") {
        std::vector<std::string> args = {"art2img", art_file.string(), "-p", palette_file.string(), "-o", output_dir.string(), "--no-transparency-fix"};
        auto argv = make_argv(args);
    ...
    TEST_CASE_FIXTURE(CliTestFixture, "CLI export with lookup options") {
        std::vector<std::string> args = {"art2img", art_file.string(), "-p", palette_file.string(), "-o", output_dir.string(), "--no-lookup"};
        auto argv = make_argv(args);
