...
void benchmark_color_operations() {
    ...
    std::cout << "Color Creation: " << (iterations / creation_time / 1000000.0) << " M ops/s\n";
    std::cout << "Format Conversion: " << (iterations / conversion_time / 1000000.0) << " M ops/s\n";
    std::cout << "Premultiplication: " << (iterations / premult_time / 1000000.0) << " M ops/s\n";
}
